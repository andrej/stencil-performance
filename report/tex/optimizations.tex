...
%		laplap-unstr-idxvar-shared-z-curves-4,    double, 512, 512,  64,   4, 508,   8, 128,   1,   8,    683697,    686700,    673325,    694566
%		laplap-unstr-idxvar-shared-z-curves-4,    double, 512, 512,  64,   8, 508,   8,  64,   1,   8,    671574,    672506,    646585,    682435
%		laplap-unstr-idxvar-shared-z-curves-4,    double, 512, 512,  64,  16, 508,   8,  32,   1,   8,    675590,    672800,    666436,    696186
%		laplap-unstr-idxvar-shared-z-curves-4,    double, 512, 512,  64, 508, 508,   2,   1,   1,  32,  14204440,  14620526,  13242579,  14820472
%		laplap-unstr-idxvar-warp-shared-z-curves-4,    double, 512, 512,  64,   4, 508,   8, 128,   1,   8,    731646,    731741,    724136,    737836
%		laplap-unstr-idxvar-warp-shared-z-curves-4,    double, 512, 512,  64,   8, 508,   8,  64,   1,   8,    696922,    696741,    685216,    706796
%		laplap-unstr-idxvar-warp-shared-z-curves-4,    double, 512, 512,  64,  16, 508,   8,  32,   1,   8,    684476,    684046,    673685,    694766
%		laplap-unstr-idxvar-warp-shared-z-curves-4,    double, 512, 512,  64, 508, 508,   2,   1,   1,  32,  12711487,  12711234,  12702345,  12727694
		\end{comment}
	%\begin{tabular}{}
	%\end{tabular}{}
\end{table}
