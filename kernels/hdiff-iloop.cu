...
void hdiff_iloop(const HdiffCudaBase::Info info,
    ...
    for(int i = i_start; i < i_stop; i++) {
        ...
        value_t lap_ijm = 
            4 * in[NEIGHBOR(i, j, k, 0, -1, 0)] /* center */
            - in[NEIGHBOR(i, j, k, -1, -1, 0)] /* left */ - in[NEIGHBOR(i, j, k, +1, -1, 0)] /* right */
            - in[NEIGHBOR(i, j, k, 0, -2, 0)] /* top */ - in[NEIGHBOR(i, j, k, 0, 0, 0)] /* bottom */;
        value_t lap_ijp =
            4 * in[NEIGHBOR(i, j, k, 0, +1, 0)] /* center */
            - in[NEIGHBOR(i, j, k, -1, +1, 0)] /* left */ - in[NEIGHBOR(i, j, k, +1, +1, 0)] /* right */
            - in[NEIGHBOR(i, j, k, 0, 0, 0)] /* top */ - in[NEIGHBOR(i, j, k, 0, +2, 0)] /* bottom */;

        // will be reused as lap_ij in next iteration
        lap_ipj =
            4 * in[NEIGHBOR(i, j, k, +1, 0, 0)] /* center */
            - in[NEIGHBOR(i, j, k, 0, 0, 0)] /* left */ - in[NEIGHBOR(i, j, k, +2, 0, 0)] /* right */
            - in[NEIGHBOR(i, j, k, +1, -1, 0)] /* top */ - in[NEIGHBOR(i, j, k, +1, +1, 0)] /* bottom */;
